...
The dataset contains a total of **`r summary_stats$total_records`** records spanning **`r summary_stats$total_years`** years and covering **`r summary_stats$total_states`** states in the US. The total prison population across all records is approximately **`r summary_stats$total_prison_pop`**. Among these, the total female prison population is **`r summary_stats$total_female_prison_pop`**, and the total male prison population is **`r summary_stats$total_male_prison_pop`**.
